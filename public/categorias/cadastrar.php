...
// 1. Checagem de Autenticação e Sessão (usando o caminho robusto)
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions-cell">
                    ...
                    <!-- Form para Deletar, usando a URL absoluta para o action (Exemplo: /ProjetoPHP/actions/categoria_deletar.php) -->
                    <form action="/ProjetoPHP/actions/categoria_deletar.php" method="POST" style="display:inline;">
                        <input type="hidden" name="id" value="<?= $categoria['id']; ?>">
                        <!-- No ambiente de produção, substitua confirm() por uma modal customizada -->
                        <button type="submit" class="button btn-danger" onclick="return confirm('Tem certeza que deseja excluir a categoria <?= htmlspecialchars($categoria['nome']); ?>?');">Deletar</button>
                    </form>
                </td>
            </tr>
            <?php endforeach; ?>
